...
def compliance_check_page():
    ...
    with col4:
        ...
        st.markdown('<p class="section-label" style="margin-top: 10px;">Location</p>', unsafe_allow_html=True)
        location_base_selection = st.selectbox(
            "Location",
            ["Pune", "Delhi", "Mumbai"],
            label_visibility="collapsed",
            width=350
            ...
            with st.spinner("Checking compliance... This may take a few moments."):
                try:
                    ...
                    data = {
                        ...
                        "inputs.Location": str(location_base_selection)
                    }
